 ...
 */
static void
fill_section(const char *content, enum lab_node_type *list, int *count,
...
{
	rc.num_title_buttons_left = 0;
	rc.num_title_buttons_right = 0;
...
{ /* !goto */
	...
	fill_section(parts[0], rc.title_buttons_left,
		&rc.num_title_buttons_left, &found_buttons);
	fill_section(parts[1], rc.title_buttons_right,
		&rc.num_title_buttons_right, &found_buttons);
...
{
	auto window_rule = new ::window_rule();
