...
theme_builtin(void)
{
	...
	parse_color("#589bda", g_theme.osd_window_switcher_thumbnail.item_active_border_color);
	parse_color("#c7e2fc", g_theme.osd_window_switcher_thumbnail.item_active_bg_color);
