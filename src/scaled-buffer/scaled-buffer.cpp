 ...
 */
static reflist<scaled_buffer> all_scaled_buffers;

/* Internal API */
static scaled_buffer_cache::iterator
find_cache_for_scale(scaled_buffer_cache &cache, double scale)
{
...
void
scaled_buffer::handle_outputs_update(void *data)
{
	double max_scale = 0;
...
/* Public API */
scaled_buffer::scaled_buffer(scaled_buffer_type type,
