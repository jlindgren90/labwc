...
struct view : public destroyable, public ref_guarded<view>, public view_data {
	...
	virtual view *get_parent() = 0;
	virtual view *get_root() = 0;
	virtual view_list get_children() = 0;
	virtual bool is_modal_dialog() = 0;
	...
	virtual void handle_map(void *) = 0;
	virtual void handle_unmap(void *) = 0;
...
struct xdg_toplevel_view : public view {
	...
	void handle_map(void *) override;
	void handle_unmap(void *) override;
